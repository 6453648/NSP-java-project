...
import javax.swing.*;
/*<applet code="First.class" width="300" height="400"> </applet> */
...
{   
    First()
    {
        ...
        JLabel teacherJLabel = new JLabel("Teacher : ",JLabel.LEFT);
        ...
        teacherJLabel.setBounds(70,50,350,20);
        ...
        sub.add("JAVA"); sub.add("COMPUTER GRAPHICS"); sub.add("COMPILER DESIGN"); sub.add("ALGORITHEM"); sub.add("INFORMATION THEORY");
        tec.add("Rekha jain"); tec.add("Manish Bhardwaj"); tec.add("Yogendra Sharma"); tec.add("vikram Kandelwal"); tec.add("Alka Rani");
        ...
        {  
            ...
            {  
            	try 
            	{
					...
					out.write("\n".getBytes());
                                        out.write("Teacher Selected : ".getBytes());
					out.write(tec.getItem(tec.getSelectedIndex()).getBytes());
					out.write("\n".getBytes());
